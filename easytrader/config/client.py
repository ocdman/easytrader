...
class CommonConfig:
    DEFAULT_EXE_PATH = r'C:\cfjc_dlwt\xiadan.EXE'
    DEFAULT_XLS_PATH = r'Y:\\Downloads\table.xls'
    DEFAULT_CSV_PATH = r'Y:\\Downloads\table.csv'
    TITLE = '网上股票交易系统5.0'

    TOOL_BAR_CONTROL_ID = 59392
    STATUS_BAR_CONTROL_ID = 59393
